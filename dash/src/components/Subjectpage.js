...
export const chaptersData = {
  10: {
    mathematics: [
      { title: "Real Numbers", videoUrl: null },
      { title: "Polynomials", videoUrl: null },
      { title: "Pair of Linear Equations in 2 Variables", videoUrl: null },
      { title: "Quadratic Equations (10)", videoUrl: null },
      { title: "Arithmetic Progressions", videoUrl: null },
      { title: "Triangles", videoUrl: null },
      { title: "Coordinate Geometry", videoUrl: null },
      { title: "Circles (10)", videoUrl: null },
      { title: "Area Related to Circle", videoUrl: null },
      { title: "Trigonometry (10)", videoUrl: null },
      { title: "Some Applications of Trigonometry", videoUrl: null },
      { title: "Surface Areas and Volumes", videoUrl: null },
      { title: "statistics", videoUrl: null },
      { title: "Probability (10)", videoUrl: null },
    ],
    physics: [
      { title: "light", videoUrl: null },
      { title: "human-eye", videoUrl: null },
      { title: "electricity", videoUrl: null },
      { title: "magnetic", videoUrl: null },
    ],
    chemistry: [
      { title: "chemical-reaction-and-equation", videoUrl: null },
      { title: "acid-base", videoUrl: null },
      { title: "metal-non-metal", videoUrl: null },
      { title: "carbon-compound", videoUrl: null },
    ],
    biology: [
      { title: "life-processes", videoUrl: null },
      { title: "control-coordination", videoUrl: null },
      { title: "reproduction", videoUrl: "https://youtu.be/7kw03dP2mQw" },
      { title: "heredity", videoUrl: null },
    ],
    SST: [
      // History
      { title: "The Rise of Nationalism in Europe", videoUrl: null },
      { title: "Nationalism in India", videoUrl: null },
      { title: "The Making of the Global World", videoUrl: null },
      { title: "The age of Industrialization", videoUrl: null },
      { title: "Print Culture and the modern World", videoUrl: null },
  
      // Geography
      { title: "Resources and Development", videoUrl: null },
      { title: "Forest and Wildlife Resources", videoUrl: null },     // project work
      { title: "Water Resources", videoUrl: null },                   // map work only
      { title: "Agriculture", videoUrl: null },
      { title: "Minerals and Energy Resources", videoUrl: null },
      { title: "Manufacturing Industries", videoUrl: null },
  
      // Political Science (Civics)
      { title: "Power Sharing", videoUrl: null },
      { title: "Federalism", videoUrl: null },
      { title: "Gender, Religion and Caste", videoUrl: null },
      { title: "Political Parties", videoUrl: null },
      { title: "Outcomes of Democracy", videoUrl: null },
  
      // Economics
      { title: "Development", videoUrl: null },
      { title: "Sectors of the Indian Economy", videoUrl: null },
      { title: "Money and Credit", videoUrl: null },
      { title: "Globalisation and the Indian Economy", videoUrl: null },
      { title: "Consumer Rights", videoUrl: null },                   // project work
    ],
  },
          ...
          <Grid container spacing={3}>
            {chapters.map((chapter) => (
              <Grid item xs={12} sm={3} key={chapter.title}>
                <Link
                  to={`/class/${classId}/${subject}/${chapter.title}`}
